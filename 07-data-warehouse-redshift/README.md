# 07 · Data Warehouse (Redshift)

> **Status:** planned — scaffolded, full build pending. Module 00 (Foundations) is the depth target this module will match.

## What this module covers

Dimensional modeling, distribution & sort keys, Spectrum, workload management, COPY/UNLOAD, and upsert patterns for idempotent loads.
